...
function ajaxValidateShipping(data) {
    return $.ajax({
        type: 'POST',
        url: '/order/Ajaxvalidateshipping',
        data: data,
        async : false,
        success:function(data){
...
function ajaxShippingTotal(zip_code, id_country) {
    ...
    if(typeof zip_code === 'undefined' && typeof id_country === 'undefined') url = '/order/Noshippingtotal';
    else if(typeof zip_code !== 'undefined' && typeof id_country !== 'undefined') url = '/order/Shippingtotal';
    else{
