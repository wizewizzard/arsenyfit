...
class GalleryImageController extends Controller
{
	...
	public function actionView($id)
	{
		...
		$this->url_create = array('/admin/galleryimage/create');
		$this->url_update = array('/admin/galleryimage/update', 'id' => $model->id);
		$this->url_delete = array('submit'=>array('/admin/galleryimage/delete', "id"=>$model->id),
			'confirm' => 'Delete?');
		$this->url_admin = array('/admin/galleryimage/admin');
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['GalleryImage']))
		{
			...
			/*var_dump($max_allowed_w);
			var_dump($max_allowed_h);*/
