...
class ConfigController extends Controller
{
	...
	public function actionView($id)
	{
		...
		$this->url_create = array('/admin/config/create');
		$this->url_update = array('/admin/config/update', 'id' => $model->id);
		$this->url_delete = array('submit'=>array('/admin/config/delete', "id"=>$model->id),
			'confirm' => 'Delete?');
		$this->url_admin = array('/admin/config/admin');
