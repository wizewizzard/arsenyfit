...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row buttons">
		<?php echo CHtml::submitButton("Предварительный просмотр", array('name' => 'preview','class' => 'global_button', 'onclick' => "this.form.target='_blank';return true;")); ?>
	</div>

	<div class="row buttons">
		<?php echo CHtml::submitButton("Сохранить", array('name' => 'publish','class' => 'global_button')); ?>
	</div>
