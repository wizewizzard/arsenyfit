...
<head>
	...
	<script type="text/javascript">
		VK.init({apiId: 5405813, onlyWidgets: true});
	</script>
</head>
...
<div class="container" id="page">
	...
	<div id="header">
        ...
        <div id="header_image"><img src="<?php echo Yii::app()->baseUrl; ?>/images/others/main_s.jpg"/></div>
	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			...
			'items'=>array(
				...
				array('label'=> '<img src="/images/others/cart_icon_white.png" alt="cart_icon" title="Cart" />',
					'url'=>array('/cart/index'),
					'itemOptions' => array(
					'id' => 'cart_icon'
				)),
				array('label'=> '<img src="/images/others/clock_icon.png" alt="clock_icon" title="Track your orders" />',
